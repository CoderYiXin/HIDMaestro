...
rem  - Runs the full live-swap regression battery (60 scenarios, ~16 min
...
rem
rem  Exit codes:
rem    0  All 60 scenarios PASSED. Safe to tag/push/release.
...
echo [3/4] Running live-swap regression battery (60 scenarios, ~16 min)...
echo.
...
echo.
echo ====================================================================
echo  [PASS] Switch Pro check + 60/60 swap scenarios passed. Safe to:
echo         git tag vX.Y.Z
